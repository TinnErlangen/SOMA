...
# load Epoch objects, stored as variables epo1 and epo2
...
for sub in subjs:
    for run_idx,run in enumerate(runs):
        epo1 = mne.read_epochs(proc_dir+"SOM_21_1_prepro-epo.fif")
        epo2 = mne.read_epochs(proc_dir+"SOM_20_1_prepro-epo.fif")
